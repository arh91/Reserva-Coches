...
public class prueba extends JDialog {
	...
	private double PrecioMedio, DiasMedia;
	private int TotalMes, NumeroAlquileres;
	String mes;
	...
	public prueba() {
		...
		
		{
			...
			lblNumAlquileres.setBounds(335, 12, 126, 13);
			panel_1.add(lblNumAlquileres);
			
			JLabel lblPrecioMedio = new JLabel("Precio Medio");
			lblPrecioMedio.setBounds(163, 12, 102, 13);
	...
	public void otrosDatos() {
		...
		textDiasMedia.setText("Dias Media");
		textTotalMes.setText("Total Mes");
		textNumAlquileres.setText("Numero Alquileres");
	}
	...
	public void PrecioMedio (double PrecioMedio, String mes) {
		try {
			//AsignarMes(mes);
